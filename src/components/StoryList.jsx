      ...
      {stories.map((story, index) => (
        <li key={index}>
          <div className="border border-slate-600 p-4 m-2 bg-slate-100">
            <a className="flex justify-center text-xl font-bold mb-1 pb-2 sm:text-lg text-center hover:text-blue-700" href={story.url} target="_blank" rel="noopener noreferrer">
              {story.title}
            </a>
